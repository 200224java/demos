...
Think of how data might have been stored in the past. Namely, in large excel spreadsheets. It was unwieldy, difficult to share, difficult to search, and difficult to share. Databases are a modern way to store data that is much more effective, and SQL is a language we use to add/update/delete information in the database and to query the database for various information quickly.
...
We separate out many of the core syntax keywords into different *SQL sublanguages* based on what each keyword relates to.
...
- DQL: Data Query Language
  - Pertains to retrieving data
  - Kind of a sublanguage, depends on who you talk to, in training we DO consider it a sublanguage
  - Only 1 command: SELECT
  - SELECT sort of counts as both DML and DQL
...
- TCL: Transaction Control Language
  ...
  - Commands: COMMIT (persist data), ROLLBACK (revert data), SAVEPOINT, SET_TRANSACTION (used to set isolation level)
...
There are 6 kinds
  - Primary Key: Data in this column(s) is unique, not null, and uniquely identifies all records in the table
    - IDs of some form are commonly used as primary keys
...
CREATE TABLE employee (
  ...
  email VARCHAR2(55) DEFAULT 'N/A' UNIQUE NOT NULL,
